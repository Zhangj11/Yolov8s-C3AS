...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(project='Drone_N', name='yolo_v8s_CBAM3')),
    ],
    name='visualizer')
...
model = dict(
    ...
    backbone=dict(
        ...
        plugins=[
            dict(cfg=dict(type='CBAM'), stages=(
                True,
                True,
                True,
                False,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=('drone', ), palette=[
            (
                20,
                220,
                60,
...
launcher = 'none'
work_dir = './work_dirs/yolov8_C3_200e_drone'
